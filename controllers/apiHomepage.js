const apiHomepage = (req, res, next) => {
    res.status(200).send({ "API Endpoints": {
        ...
        "GET /api/topics/:topic_slug/articles" : "Return all the articles for a certain topic",
        "POST /api/topics/:topic_slug/articles" : "Add a new article belonging to a certain topic",
        "GET /api/articles" : "Return all the articles",
        "GET /api/articles/:article_id" : "Return an individual article with the provided article id",
